<article class="post_item">
	<figure class="post_item__thumb">
		<a href="<?php echo get_the_permalink(); ?>" aria-hidden="true" tabindex="-1">
			<?php $img_id = get_post_thumbnail_id( get_the_ID() ); ?>
            <?php echo wp_get_attachment_image( $img_id, 'medium', false, array( 'alt' => get_alt( $img_id ), 'class' => 'object_fit' ) ); ?>
		</a>
	</figure>
    <div class="post_item__meta">
	    ...
	    <?php echo wp_kses_post( custom_tax_linked( $post->ID, 'category' ) ) ?>
